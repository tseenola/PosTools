...
public class TripleDesUtils {
     ...
     * @param pKey 密钥
     * @param pData 被加密数据
     * @param pITripleDes 3DES 加解密算法实现者（已经有一个默认实现，{@link TripleDesImpl}），
     ...
     * @param pKey 密钥
     * @param pData 被加密数据
     * @param pITripleDes 3DES 加解密算法实现者（已经有一个默认实现，{@link com.urovo.pos.security.algorithm.TripleDesImpl}），
     *              如果有自己的特殊3DES加解密算法，请继承{@link ITripleDes}
     * @return 加密结果
     */

...
public class MacCalculater_union implements IMacCalculater {
    private MacCalculater_union(){}

    private static final MacCalculater_union sMacCalculaterEcb = new MacCalculater_union();
    public static MacCalculater_union getInstance(){
